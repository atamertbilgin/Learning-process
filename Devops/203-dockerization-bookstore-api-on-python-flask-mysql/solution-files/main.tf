...
resource "aws_instance" "tf-docker-ec2" {
  ...
  user_data = <<-EOF
          ...
          TOKEN="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/atamertbilgin/atamert-repo/main/"
          ...
          docker build -t atamertcw/bookstoreapi:latest .
          docker-compose up -d
          EOF
...
resource "aws_security_group" "tf-docker-sec-gr" {
  name = "docker-sec-gr-203-atamert"
  tags = {
